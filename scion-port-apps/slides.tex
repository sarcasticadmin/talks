...
\begin{frame}
  ...
  \begin{center}
    ...
    \lstinputlisting[frame=single]{snippets/natsListen.go}
  \end{center}
  \note[item]{SCiON does not have an implementation of TCP on top of SCION}
\end{frame}

\begin{frame}
  \frametitle{SCiON NATS Client}
  \begin{center}
    \lstinputlisting[frame=single]{snippets/natsDialScion.go}
  \end{center}
  %\begin{center}
  %\end{center}
\end{frame}
...
\frametitle{URL Formatting}
  \begin{columns}[t]
      \begin{column}{0.48\linewidth}
        \lstinputlisting[frame=single]{snippets/mangledurl.go}
      \end{column}
      \begin{column}{0.48\linewidth}
        \lstinputlisting[frame=single]{snippets/panmangle.go}
      \end{column}
  \end{columns}
  \begin{center}
    \small{nats://17-ffaa:1:1,10.10.0.1:4222 => nats://[17-ffaa:1:1,10.10.0.1]:4222}
  \end{center}
  %\begin{center}
  %\end{center}
\end{frame}
